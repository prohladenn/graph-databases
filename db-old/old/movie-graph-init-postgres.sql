...
CREATE TABLE triple
(
    subject   integer NOT NULL REFERENCES id_to_entity (id),
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"As Good as It Gets", "released":1997, "tagline":"A comedy from the heart that goes for the throat."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"What Dreams May Come", "released":1998, "tagline":"After life there is more. The end is just the beginning."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('SnowFallingonCedars') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Snow Falling on Cedars", "released":1999, "tagline":"First loves last. Forever."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('YouveGotMail') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"You`ve Got Mail", "released":1998, "tagline":"At odds in life... in love on-line."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"Sleepless in Seattle", "released":1993, "tagline":"What if someone you never met, someone you never saw, someone you never knew was the only someone for you?"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheMatrix') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Matrix", "released":1999, "tagline":"Welcome to the Real World"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheMatrixReloaded') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Matrix Reloaded", "released":2003, "tagline":"Free your mind"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"The Matrix Revolutions", "released":2003, "tagline":"Everything that has a beginning has an end"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheDevilsAdvocate') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Devil`s Advocate", "released":1997, "tagline":"Evil has its winning ways"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"A Few Good Men", "released":1992, "tagline":"In the heart of the nation`s capital, in a courthouse of the U.S. government, one man will stop at nothing to keep his honor, and one will stop at nothing to find the truth."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TopGun') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Top Gun", "released":1986, "tagline":"I feel the need, the need for speed."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('JerryMaguire') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Jerry Maguire", "released":2000, "tagline":"The rest of his life begins now."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('JoeVersustheVolcano') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Joe Versus the Volcano", "released":1990, "tagline":"A story of love, lava and burning desire."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"When Harry Met Sally", "released":1998, "tagline":"Can two friends sleep together and still love each other in the morning?"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"That Thing You Do", "released":1996, "tagline":"In every life there comes a time when that thing you dream becomes that thing you do"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"The Replacements", "released":2000, "tagline":"Pain heals, Chicks dig scars... Glory lasts forever"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"Stand By Me", "released":1986, "tagline":"For some, it`s the last real taste of innocence, and the first real taste of life. But for everyone, it`s the time that memories are made of."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"RescueDawn", "released":2006, "tagline":"Based on the extraordinary true story of one man`s fight for freedom"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheBirdcage') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Birdcage", "released":1996, "tagline":"Come as you are"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('Unforgiven') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Unforgiven", "released":1992, "tagline":"It`s a hell of a thing, killing a man"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"Johnny Mnemonic", "released":1995, "tagline":"The hottest data on earth. In the coolest head in town"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('CloudAtlas') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Cloud Atlas", "released":2012, "tagline":"Everything is connected"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheDaVinciCode') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Da Vinci Code", "released":2006, "tagline":"Break The Codes"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('VforVendetta') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"V for Vendetta", "released":2006, "tagline":"Freedom! Forever!"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('SpeedRacer') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Speed Racer", "released":2008, "tagline":"Speed has no limits"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('NinjaAssassin') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Ninja Assassin", "released":2009, "tagline":"Prepare to enter a secret world of assassins"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('TheGreenMile') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Green Mile", "released":1999, "tagline":"Walk a mile you`ll never forget."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('FrostNixon') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Frost/Nixon", "released":2008, "tagline":"400 million people were waiting for the truth."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('Hoffa') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Hoffa", "released":1992, "tagline":"He didn`t want law. He wanted justice."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('Apollo13') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Apollo 13", "released":1995, "tagline":"Houston, we have a problem."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('Twister') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Twister", "released":1996, "tagline":"Don`t Breathe. Don`t Look Back."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('CastAway') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Cast Away", "released":2000, "tagline":"At the edge of the world, his journey begins."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"One Flew Over the Cuckoo`s Nest", "released":1975, "tagline":"If he`s crazy, what does that make you?"}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('SomethingsGottaGive') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"Something`s Gotta Give", "released":2003}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"Bicentennial Man", "released":1999, "tagline":"One robot`s 200 year journey to become an ordinary man."}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"Charlie Wilson`s War", "released":2007, "tagline":"A stiff drink. A little mascara. A lot of nerve. Who said they couldn`t bring down the Soviet empire."}'
FROM new_id ni;

WITH new_id AS (INSERT INTO id_to_entity (entity) VALUES ('ThePolarExpress') RETURNING id)
INSERT
INTO property
SELECT ni.id, '{"type": "Movie", "title":"The Polar Express", "released":2004, "tagline":"This Holiday Season... Believe"}'
FROM new_id ni;
...
INTO property
SELECT ni.id,
       '{"type": "Movie", "title":"A League of Their Own", "released":1992, "tagline":"Once in a lifetime you get a chance to do something different."}'
FROM new_id ni;

-- Predicates
INSERT INTO id_to_predicate (predicate)
VALUES ('ACTED_IN');
INSERT INTO id_to_predicate (predicate)
VALUES ('DIRECTED');
INSERT INTO id_to_predicate (predicate)
